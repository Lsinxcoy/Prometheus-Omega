...
class KnowledgeBridge:
    ...
    def register(self, from_agent: str, to_agent: str, knowledge: str) -> None:
        """注册知识桥接"""
...
class VectorClock:
    ...
    def set_clock(self, clock: Dict[str, int]) -> None:
        """设置时钟"""
...
class CausalKG:
    ...
    def add_causality(self, cause: str, effect: str, weight: float = 1.0) -> None:
        """添加因果边"""
