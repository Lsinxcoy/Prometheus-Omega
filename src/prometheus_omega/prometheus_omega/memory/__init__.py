...
class FourNetworkMemory:
    ...
    def retain(self, content: str, network: MemoryNetwork = MemoryNetwork.WORLD,
               entity_ids: List[str] = None, tags: List[str] = None) -> FourNetworkFact:
        """retain: 存入记忆"""
    ...
    def recall(self, query: str, network: MemoryNetwork = None) -> List[FourNetworkFact]:
        """recall: 检索记忆"""
        results = []
    ...
    def reflect(self, query: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "key_themes": self._extract_themes(relevant),
